...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_indice_range', 
                    default = [0,169], 
                    nargs = '+',
                    type = int,
                    help = 'indice range for training datasets.')          
    parser.add_argument('--validation_indice_range', 
                    default = [169, 196], 
                    nargs = '+', 
                    type = int,
    ...
    parameters = {
        ...
        "training_indices": list(range(args.training_indice_range[0], args.training_indice_range[1])) if len(args.training_indice_range)>1 else list(range(args.training_indice_range[0])),
