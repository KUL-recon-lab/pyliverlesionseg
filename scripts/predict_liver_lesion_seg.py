...
parser.add_argument('--WholeLiverModel', 
                    default ='../trained_models/model_unet_ct_mr_liv_seg_resize_1.5mm_med_3_resize_3mm_20201011_dice_loss_val_binary_dice_mean.hdf5',
                    help = 'the path of the trained CNN model for liver segmentation')
parser.add_argument('--LesionsModel', 
                    default = '../trained_models/model_unet_ct_mr_lesion_seg_resize_1mm_1mm_3mm_20220207_dice_loss_val_binary_dice_mean.hdf5',
...
CNN_liver_lesion_seg_CT_MR_main(data_input, liver_seg_dir, WholeLiverModel, LesionsModel, seg_liver = seg_liver, seg_lesion = seg_lesion, save_nifti = save_nifti, input_nifti = input_nifti, Modality = Modality)
